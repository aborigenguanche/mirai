...
// ─── Specialties ────────────────────────────────────────────
// BUG 10 FIX: fetchSpecialties se llamaba sin caché en 4 sitios distintos
// (PlanDiaPage, PerfilPage, MisErroresPage, SimulacroPage) cada vez que
// se montaban. Son datos estáticos — una sola petición en toda la sesión.
...
// Para invalidar la caché si se añaden especialidades desde el admin
...
// ─── Analytics ─────────────────────────────────────────────
// BUG 9 FIX: getUserAnalytics llamaba a supabase.rpc('get_user_analytics')
// que no existe en la BD → siempre devolvía null silenciosamente.
// Eliminada. La tasa se calcula directamente en PlanDiaPage desde
